...
func (x *Message) GetAuthor() *Message_Person {
	if x != nil {
		return x.Author
	}
	return nil
...
func (x *Message_Person) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Message_Person) ProtoMessage() {}

func (x *Message_Person) ProtoReflect() protoreflect.Message {
	mi := &file_proto_message_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Message_Person.ProtoReflect.Descriptor instead.
func (*Message_Person) Descriptor() ([]byte, []int) {
	return file_proto_message_proto_rawDescGZIP(), []int{0, 0}
}

func (x *Message_Person) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *Message_Person) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x0f, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x50, 0x65, 0x72, 0x73,
	0x6f, 0x6e, 0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x65,
	0x78, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x1a, 0x2c,
...
var file_proto_message_proto_goTypes = []interface{}{
	...
	(*Message_Person)(nil), // 1: Message.Person
}
var file_proto_message_proto_depIdxs = []int32{
	1, // 0: Message.author:type_name -> Message.Person
